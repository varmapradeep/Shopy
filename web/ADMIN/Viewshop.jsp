                ...
                <tbody>
                    <%
                        try {
                            ...
                            String Query = "SELECT * FROM tbl_shop tc INNER JOIN tbl_login tl ON tc.loginid=tl.loginid INNER JOIN tbl_district td ON tc.district=td.districtid INNER JOIN tbl_city t ON tc.city=t.cityid";
                    ...
                    <tr>
                        ...
                        <td class="w3-xlarge"> <a onclick="return confirm('This Shop Will be Approved.\n Do you want to Continue?')" href="Shopapprove.jsp?id=<%=rs.getString("shopid")%>" class="fa fa-check"></a></td>
                        <td class="w3-xlarge"> <a onclick="return confirm('This Shop Will be Rejected.\n Do you want to Continue?')" href="Shopapprove.jsp?id=<%=rs.getString("shopid")%>" class="fa fa-close"></a></td>
