    ...
    if ((contentType.indexOf("multipart/form-data") >= 0)) {
        ...
        try {
            ...
            try {
                ...
                String s = "insert into tbl_subcategory(categoryid,subcategoryname,subcategorydesc,subcategoryimg) values('" + Category + "','" + Subcategory + "','" + subcategorydesc + "','" + Subcategoryimg1 + "')";
