                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <%
                                    try {
                                        ...
                                        while (name.next()) {
                                %>
                                <input type="text" class="form-control" <%=name.getString("cpyproductname")%>name="cpyprdname" id="cpyprdname" placeholder="Product Name">
                                <%
                                        }
                                    } catch (Exception e) {
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="cpyprddesc" name="cpyprddesc" placeholder="Product Description">
                            </div>
                        </div>
                    </div>
                    <div class="row">
