<!-- title -->
<title>Shopy-Shopping</title>


<!-- favicon -->
<link rel="shortcut icon" type="image/png" href="assets/img/logo1.png" style="width: 50%;height: 50%">
<!-- google font -->
                ...
                <div class="main-menu-wrap">
                    ...
                    <nav class="main-menu">
                        <ul>
                            ...
                            <li><a href="#">Buy</a>
                                <ul class="sub-menu">
                                    <li><a href="shopview_companyproducts.jsp">Company Products</a></li>
